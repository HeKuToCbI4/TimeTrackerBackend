...
urlpatterns = [
    ...
    path("process_category_mapping/", include("api.v1.process_category_mapping.urls")),
    ...
    path("window_subcategory_mapping/", include("api.v1.process_category_mapping.urls")),
]
